...
<h3 id="event_title">Event zu Feld ID:<?=$field_id;?> hinzuf&uuml;gen</h3>
<br />
...
<ul class="nav nav-tabs" id="add_event_tabs" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="tab-5-tab" data-toggle="tab" href="#tab5" role="tab" aria-controls="tab5" aria-selected="false">State</a>
  </li>
</ul>
			...
			if( field.creation_date == field_id ){
				...
				field.field_events.forEach( function( event ){
					...
					if( event.event_id == event_id ){
						...
						if( event.data.action_target_is_action_exec == 'true' ){

							$('#new_event_form input[name=\'action_target_is_action_exec\']').attr( 'checked' , 'checked' );
